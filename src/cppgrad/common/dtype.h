...
enum class DType { INT8, INT32, INT64, UINT8, UINT32, FLOAT16, BFLOAT16, FLOAT32, FLOAT64, BOOL8, UNKNOWN };
...
inline constexpr int promote_rank(DType d) {
    ...
    case DType::FLOAT16:
        return 4;
    case DType::BFLOAT16:
        return 4; // same width as fp16; fp32 still wins over both
    case DType::INT64:
        return 3;
    case DType::UINT32:
    case DType::INT32:
...
// Convenience alias.
template <typename T> constexpr DType dtype_v = dtype_of<T>();
