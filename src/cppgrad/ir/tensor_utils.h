...
from_vector(const std::vector<T> &data, const std::vector<size_t> &shape,
...
utils::Ref<Tensor>
full(const std::vector<size_t> &shape, double fill_value,
     cppgrad::backend::DeviceType device_type = cppgrad::backend::DeviceManager::default_device_type(),
...
utils::Ref<Tensor>
uniform(const std::vector<size_t> &shape, float min = -1.0f, float max = 1.0f,
        cppgrad::backend::DeviceType device_type = cppgrad::backend::DeviceManager::default_device_type(),
        cppgrad::common::DType dtype = cppgrad::common::DType::FLOAT32);
utils::Ref<Tensor>
normal(const std::vector<size_t> &shape, float mean = 0.0f, float stddev = 1.0f,
       cppgrad::backend::DeviceType device_type = cppgrad::backend::DeviceManager::default_device_type(),
       cppgrad::common::DType dtype = cppgrad::common::DType::FLOAT32);

// Rank-0 scalar constant with explicit device/dtype
utils::Ref<Tensor>
scalar(double value, cppgrad::backend::DeviceType device_type = cppgrad::backend::DeviceManager::default_device_type(),
       cppgrad::common::DType dtype = cppgrad::common::DType::FLOAT32);
