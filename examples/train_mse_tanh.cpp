...
static float compute_accuracy_tanh(const utils::Ref<ir::Tensor> &tanh_out, const utils::Ref<ir::Tensor> &y_true) {
...
int main() {
    ...
    auto forward_tanh = [&](const utils::Ref<ir::Tensor> &x) { return ir::tanh(forward_logits(x)); };
