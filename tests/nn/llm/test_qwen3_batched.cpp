...
int main() {
    ...
    Qwen3Config mixed{
        64, 4, 128, 256, 4096,   // hidden, layers, intermediate, vocab, max_pos
        4, 2, 16,                // attn_heads, kv_heads, head_dim
        16, 2, 16, 4, 4,         // linear: key_dim, key_heads, val_dim, val_heads, conv_kernel
        1e-6, 1000000,           // rms_norm_eps, rope_theta
        false, {}, 1.0,          // mrope (full rotary to avoid section deps)
